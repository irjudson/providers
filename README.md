...
Providers provide implementations against external services like message transport, sending email, and caching services. This enables swapping in different pieces of backing infrastructure and isolates clients and applications from this infrastructure so they can run in different tiers of the network.
